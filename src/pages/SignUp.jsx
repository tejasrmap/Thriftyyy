    ...
    <div className="min-h-screen bg-[#FCFCFC] flex flex-col justify-center py-20 px-6 lg:px-8 relative">
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <p className="text-black/40 text-sm font-medium tracking-tight">
          Apply to join the Thriftyy stylist circle.
        </p>
      </div>
      ...
      >
        <div className="bg-white border border-black/[0.05] shadow-sm rounded-lg py-12 px-10">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div>
              <Label htmlFor="fullName" className="text-[11px] font-bold uppercase tracking-[0.2em] text-black/50 mb-3 block">Full Name</Label>
              <Input
                id="fullName"
                name="fullName"
                type="text"
            ...
            <div>
              <Label htmlFor="password" className="text-[11px] font-bold uppercase tracking-[0.2em] text-black/50 mb-3 block">Password</Label>
              <Input
                id="password"
                name="password"
                type="password"
            ...
            >
              {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : "Request Membership"}
            </Button>
          </form>
          ...
          <div className="mt-10 text-center">
            <span className="text-black/30 text-[11px] font-bold mr-2 uppercase tracking-[0.1em]">Already a member?</span>
            <Link
              to="/signin"
