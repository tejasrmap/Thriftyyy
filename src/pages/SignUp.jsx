  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-[20%] left-[-10%] w-[40%] h-[40%] rounded-full bg-foreground/5 blur-[120px]" />
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-foreground/5 blur-[120px]" />
      </div>
      ...
      >
        <div className="bg-card py-8 px-6 shadow-[0_8px_40px_rgba(0,0,0,0.08)] sm:rounded-[32px] sm:px-10 border border-border/50">
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground font-medium">
            ...
            <a href="#" className="font-semibold text-foreground hover:text-primary transition-colors hover:underline">Terms of Service</a>
            {" "}and{" "}
            <a href="#" className="font-semibold text-foreground hover:text-primary transition-colors hover:underline">Privacy Policy</a>.
          </div>
